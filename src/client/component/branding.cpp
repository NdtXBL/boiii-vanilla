...
namespace branding
{
	namespace
	{
		void draw_branding()
		{
			...
			game::R_AddCmdDrawText("BOIII-Vanilla", std::numeric_limits<int>::max(), font, static_cast<float>(x),
	...
	struct component final : client_component
	{
		void post_unpack() override
		{
			...
			utils::hook::copy_string(0x14303F3D8_g, "BOIII Vanilla");
